...
export const HOTEL_QUESTIONS: Question[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/kind.webp",
    title: "资产种类多",
    description:
      "客房设备、餐饮设备、办公设备等种类繁多，管理难度大，对管理精细度要求高。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/dilapidation.webp",
    title: "资产损耗率高",
    description: "客房设备（如电视、空调）使用频繁，损耗率高，采购维护成本高。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/inventory.webp",
    title: "盘点工作繁重",
    description: "大规模资产盘点耗时长，人工操作易费时费力，且容易出错。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/dispersion.webp",
    title: "资产分散",
    description:
...
export const FABRICATION_QUESTIONS: Question[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/posting.webp",
    title: "资产账目混乱",
    description:
      "资产规模庞大、价值高、种类繁多，缺乏统一台账和编码，导致数据不准确、不完整。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/computer.webp",
    title: "设备管理混乱",
    description:
...
export const RETAIL_QUESTIONS: Question[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/shop.webp",
    title: "门店分布广",
    description: "多门店资产分布广泛，需要跨地域盘点，导致管理难度增加。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/chat.webp",
    title: "资产信息不对成",
    description:
  ...
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/icon/search.webp",
    title: "审批流程不规范",
    description:
...
export const HOTEL_SOLUTIONS: SectionData[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/hotel_solution1.webp",
    title: "设备分类管理",
    description: "支持资产分类管理，轻松管理客房、餐饮等设备。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/hotel_solution2.webp",
    title: "完善的设备维护管理",
    description:
      "资产使用人员可快速报修、设置维护计划等，系统自动通知维修人员，实时追踪维修进度。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/hotel_solution3.webp",
    title: "移动盘点",
    description:
...
export const FABRICATION_SOLUTIONS: SectionData[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/fabrication_solution1.webp",
    title: "资产全生命周期管理",
    description:
      "实现资产、设备从采购、入库、领用、归还、调拨、借用、维护、维修、盘点、折旧及报废等各个环节的全生命周期管理。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/fabrication_solution2.webp",
    title: "资产数据可视化",
    description:
      "资产台账清晰 记录完整资产情况一目了然；资产的分布情况和使用状态可视化管理，帮助企业发现资产闲置或过度使用问题，优化资产配置，提高资产整体利用率。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/fabrication_solution3.webp",
    title: "完善的设备管理",
    description:
...
export const RETAIL_SOLUTIONS: SectionData[] = [
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/retail_solution1.webp",
    title: "资产全生命周期管理",
    description:
      "实现资产、设备从采购、入库、领用、归还、调拨、借用、维护、维修、盘点、折旧及报废等各个环节的全生命周期管理。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/retail_solution2.webp",
    title: "资产数据可视化",
    description:
      "资产台账清晰 记录完整资产情况一目了然；资产的分布情况和使用状态可视化管理，帮助企业发现资产闲置或过度使用问题，优化资产配置，提高资产整体利用率。",
  },
  {
    icon: "https://ziweiton.oss-cn-hangzhou.aliyuncs.com/retail_solution3.webp",
    title: "资产标签化",
    description:
